        ...
        <table class="table table-hover">
            @foreach($pessoa->telefones as $telefone)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('agenda.delete.Telefone', ['id'=> $telefone->id]) }}" class="text-danger" data-toggle="tooltip" data-placement="top" title="Apagar"><i class="fa fa-minus-circle"></i></a>
                    </td>
                </tr>
            @endforeach
        </table>
